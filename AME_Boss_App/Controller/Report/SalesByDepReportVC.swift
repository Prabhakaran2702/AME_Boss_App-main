...
extension SalesByDepReportVC : UITextFieldDelegate {
...
class SalesByDepReportVC: UIViewController , UITableViewDelegate, UITableViewDataSource  {
    ...
    @objc func openPieChart(){
        ...
        vc.titleString = "Sales By Department"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell.deffTitleLabel.text = "Department"
    ...
    func APIs(){
        ...
        let BusinessCenter = defaults.string(forKey: "BusinessCenter")!
        let dictParams = ["": ""]
        let URL = "SalesByDept.php?Branch=" + BusinessCenter + "&FromDate=" + SelectedFromDate + "&ToDate=" + SelectedToDate
        print(URL)
                                    ...
                                    if let array2 = dictionary as? NSArray{
                                        for obj2 in array2 {
                                            if let dict2  = obj2 as? NSDictionary {
                                                let DEPT_NAME = dict2.value(forKey: "DEPT_NAME") as! String

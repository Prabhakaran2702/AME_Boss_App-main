...
extension SalesByWaiterReportVC : UITextFieldDelegate {
...
class SalesByWaiterReportVC: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func openPieChart(){
        ...
        vc.titleString = "Sales By Waiter"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell.deffTitleLabel.text = "Waiter"
    ...
    func APIs(){
        ...
        let BusinessCenter = defaults.string(forKey: "BusinessCenter")!
        let dictParams = ["": ""]
        let URL = "SalesByWaiterMobile.php?Branch=" + BusinessCenter + "&FromDate=" + SelectedFromDate + "&ToDate=" + SelectedToDate
        print(URL)
                                    ...
                                    if let array2 = dictionary as? NSArray{
                                        for obj2 in array2 {
                                            if let dict2  = obj2 as? NSDictionary {
                                                let WAITER = dict2.value(forKey: "WAITER") as! String
                                                ...
                                                let SingleItemObj = SingleItem(mode: WAITER, sst: SST, amount: WITHSST)

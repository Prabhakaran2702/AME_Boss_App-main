...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
   ...
   // hud.activityIndicatorColor = [self colorFromHexString:@"FF4611"];
  //  hud.labelColor = [self colorFromHexString:@"FF4611"];
    
    
    hud.activityIndicatorColor = [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0];
    
    hud.labelColor =  [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opaque = NO;
		self.backgroundColor = [UIColor colorWithHue:1 saturation:1 brightness:0 alpha:0.7];
